            ...
            >
              ...
              <template v-else>
                <div class="flex gap-4 mb-5">
                  <MainButton label="Edit" outlined id="edit-car" @click="showCarDialogModal">
                    <template #icon>
                      <IconEdit></IconEdit>
                    </template>
                  </MainButton>

                  <MainButton outlined id="delete-car" @click="showConfirmDialog">
                    <template #icon>
                      <IconDelete />
                    </template>
                  </MainButton>
...
const onDeleteCar = () => {
  carsApi.deleteCar(actualCar.value.id)
